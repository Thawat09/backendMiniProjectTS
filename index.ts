...
import config from './src/configs/app'; // configuration จากไฟล์ configs/app.js
import routes from './src/routes/index'; // นำเข้าเส้นทางของแอปพลิเคชัน

// กำหนดการตั้งค่าของ log4js เพื่อให้แอปพลิเคชันทำการบันทึก log ตามที่กำหนด
log4js.configure({
    appenders: {
...
// เพิ่ม middleware ของ log4js เพื่อบันทึก log ของแอปพลิเคชัน
